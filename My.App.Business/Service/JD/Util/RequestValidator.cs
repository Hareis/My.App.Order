...
namespace My.App.Business.Service.JD.Util
{
    ...
    {        
        ...
        public static void ValidateRequired(string name, object value) {
            if (value == null) {
                throw new ApiException(ERR_CODE_PARAM_MISSING, string.Format(ERR_MSG_PARAM_MISSING, name), "");
            } else {
        ...
        public static void ValidateMaxLength(string name, string value, int maxLength) {
            if (value != null && value.Length > maxLength) {
                throw new ApiException(ERR_CODE_PARAM_INVALID, string.Format(ERR_MSG_PARAM_INVALID, name), "");
            }
        }
